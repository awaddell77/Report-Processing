#mapping function
#factory-ish design 
import Fleurco_spiff, Pcp_spiff, Qmdrain_spiff, Mti_spiff, Jason_spiff, Crosswater_ammara_spiff, Delta_brizo_spiff, Barclay_spiff, Mtnplbg_spiff, Ameste_spiff
...
def spiff_match_creator_b(spiff_type, eclipse_file, master_file):
	spiff_classes = { 'Fleurco':Fleurco_spiff.Fleurco_spiff, 'PCP':Pcp_spiff.Pcp_spiff, 
					...
					'MTNPLBG':Mtnplbg_spiff.Mtnplbg_spiff, 'Ameste':Ameste_spiff.Ameste_spiff
